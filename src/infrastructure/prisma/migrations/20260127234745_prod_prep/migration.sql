...
CREATE TABLE [dbo].[Flashcard] (
    ...
    CONSTRAINT [Flashcard_userId_languageId_practiceId_key] UNIQUE NONCLUSTERED ([userId],[languageId],[practiceId])
);
...
CREATE TABLE [dbo].[Listening] (
    ...
    CONSTRAINT [Listening_userId_languageId_practiceId_key] UNIQUE NONCLUSTERED ([userId],[languageId],[practiceId])
);
...
CREATE TABLE [dbo].[Practice] (
    ...
    CONSTRAINT [Practice_languageId_name_key] UNIQUE NONCLUSTERED ([languageId],[name])
);
...
CREATE TABLE [dbo].[Reading] (
    ...
    CONSTRAINT [Reading_userId_languageId_practiceId_key] UNIQUE NONCLUSTERED ([userId],[languageId],[practiceId])
);
...
CREATE TABLE [dbo].[Writing] (
    ...
    CONSTRAINT [Writing_userId_languageId_practiceId_key] UNIQUE NONCLUSTERED ([userId],[languageId],[practiceId])
);
