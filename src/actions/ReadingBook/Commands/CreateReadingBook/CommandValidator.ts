// IMPORTS
import { z } from "zod"
import { CREATE_READING_BOOK_COMMAND } from "./Command"
...
// CHEK IS FILE EXTENSION ALLOWED
...
export const CreateReadingBookCommandValidator = z.object({

  type: z.literal(CREATE_READING_BOOK_COMMAND),
