...
// ACTIONS
import { FlashcardCategoryAddOrUpdate } from "@/src/actions/crud"
// REDUCER & HANDLERS & CUSTOM EFFECTS
import { useFlashcardAddOrEditReducer } from "@/src/components/FlashcardAddOrEditComponent/useFlashcardAddOrEditReducer"
...
export default function FlashcardAddOrEditComponent ({type, itemId} : FlashcardAddOrEditComponentProps) {
    ...
    // USE EFFECT
    useFlashcardAddOrEditCustomEffect({itemId, state, router, dispatch, setLoading, showAlert})
    ...
    return (
        ...
        <div className="flex items-center justify-center p-4">
            ...
            <div className="p-6">
                <h2 className="text-2xl font-bold text-center text-gray-800 mb-8">{type == "Create" ? "Create Deck Category" : "Edit Deck Category"}</h2>
                ...
                <form action={formAction} className="space-y-6">
                    ...
                    <input type="hidden" name="table" value="fcategories" />
