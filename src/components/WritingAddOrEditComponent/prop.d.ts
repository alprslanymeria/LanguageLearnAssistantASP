...
import { Language, ReadingBook, WritingBook } from "@prisma/client"
import { AppRouterInstance } from "next/dist/shared/lib/app-router-context.shared-runtime"

// COMPONENT PROPS
export type WritingAddOrEditComponentProps = {
...
// USE EFFECT
export type useWritingAddOrEditCustomEffectProps = {
  
  state: ApiResponse<WritingBook> | undefined
