...
import { useFlashcardEditReducer } from "@/src/components/FlashcardEditComponent/useFlashcardEditReducer"
import { useFlashcardEditCustomEffect } from "@/src/components/FlashcardEditComponent/useFlashcardEditCustomEffect"
...
export default function FlashcardEditComponent ({itemId} : FlashcardEditComponentProps) {
    ...
    // USE EFFECT
    useFlashcardEditCustomEffect({itemId, state: states.state, dispatch, setLoading, showAlert})
    ...
    return (
        ...
        <div className="flex items-center justify-center p-4">
            ...
            <div className="p-6">
                <h2 className="text-2xl font-bold text-center text-gray-800 mb-8">Edit Category</h2>
                ...
                <form className="space-y-6" method="POST" onSubmit={(e) => handleSubmit({ e, dispatch, setLoading })}>
                    ...
                    <button
                        disabled= {(isLoading && loadingSource === "FlashcardEditHandleSubmit") || isPendingBetterAuth}
                        type="submit"
                        className="w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
                    >
                        {isLoading && loadingSource === "FlashcardEditHandleSubmit" ? (
