...
export default function FlashcardAddComponent () {
    ...
    // ACTION
    const [state, formAction, isPending] = useActionState(CreateFlashcardCategory, undefined)
    ...
    // USE EFFECT
    useFlashcardAddCustomEffect({state, router, dispatch, setLoading, showAlert})
