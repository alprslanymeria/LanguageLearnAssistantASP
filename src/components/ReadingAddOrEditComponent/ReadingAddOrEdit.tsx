...
// TYPES
import { ReadingAddOrEditComponentProps } from "@/src/components/ReadingAddOrEditComponent/prop"
// ACTIONS
import { ReadingAddOrUpdate } from "@/src/actions/crud"
// REDUCER & HANDLERS & CUSTOM EFFECTS
import { useReadingAddOrEditReducer } from "@/src/components/ReadingAddOrEditComponent/useReadingAddOrEditReducer"
...
export default function ReadingAddOrEditComponent ({type, itemId} : ReadingAddOrEditComponentProps) {

    // ACTION
    const [state, formAction, isPending] = useActionState(ReadingAddOrUpdate, undefined)

    // HOOKS
    const {states , dispatch} = useReadingAddOrEditReducer()
    ...
    // USE EFFECT
    useReadingAddOrEditCustomEffect({state, router, itemId, setLoading, dispatch, showAlert})
        ...
        <div className="flex items-center justify-center p-4">
            ...
            <div className="p-6">
                ...
                <form action={formAction} className="space-y-6">
                    ...
                    <input type="hidden" name="table" value="rbooks" />
